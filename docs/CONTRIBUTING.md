...
[Feel Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
...
This section guides you through submitting a bug report for Feel Core.
...
* **Did the problem start happening recently** (e.g. after updating to a new
  version of Feel Core, Feel or any other repository) or was this always a
  problem?
...
Feel Core, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
  or point out the part of Feel Core which the suggestion is related to. You
...
* **Explain why this enhancement would be useful** to most Feel and
  Feel Core users.
* **Specify which version of Feel and Feel Core you’re using.**
...
On Feel we are using [Prettier](https://prettier.io/) and
